...
public class DBService {
	...
	public void instanciaBaseDeDados() {
		...
		Livro livro2 = new Livro(null, "Estudar", "Estudar Dinamarquês com Inglês", LocalDateTime.parse("01/02/2022 12:45", formato) , null);
		Livro livro3 = new Livro(null, "Estudar", "Estudar lógica com C++", LocalDateTime.parse("31/05/2022 13:32", formato) , null);
		Livro livro4 = new Livro(null, "Estudar", "Estudar javascript com HTML5 e CSS3", LocalDateTime.parse("17/08/2022 23:59", formato) , null);
